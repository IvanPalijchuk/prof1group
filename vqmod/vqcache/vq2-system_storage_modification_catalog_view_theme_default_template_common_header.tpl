...
"address": { // адрес
  ...
  "postalCode":"04070" 
				...
				<!-- Label For Specials -->
				<?php if($label_for_specials_label_style && $label_for_specials_status){ ?>
					<style>
						.dc-label-for-specials {
							position: absolute;
							text-align: center;
							z-index: 99;
							<?php if(isset($label_for_specials_label_style['position']) && $label_for_specials_label_style['position'] == 'top-left'){ ?>
								left: 20px;
								top: 5px;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['position']) && $label_for_specials_label_style['position'] == 'top-right'){ ?>
								right: 20px;
								top: 5px;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['position']) && $label_for_specials_label_style['position'] == 'bottom-left'){ ?>
								left: 20px;
								bottom: 62px;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['position']) && $label_for_specials_label_style['position'] == 'bottom-right'){ ?>
								right: 20px;
								bottom: 62px;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['width']) && $label_for_specials_label_style['width']){ ?>
								width: <?php echo $label_for_specials_label_style['width'] ?>px;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['padding']) && $label_for_specials_label_style['padding']){ ?>
								padding: <?php echo $label_for_specials_label_style['padding'] ?>px;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['line_height']) && $label_for_specials_label_style['line_height']){ ?>
								line-height: <?php echo $label_for_specials_label_style['line_height'] ?>px;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['text_size']) && $label_for_specials_label_style['text_size']){ ?>
								font-size: <?php echo $label_for_specials_label_style['text_size'] ?>px;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['border_radius']) && $label_for_specials_label_style['border_radius']){ ?>
								border-radius: <?php echo $label_for_specials_label_style['border_radius'] ?>px;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['text_color']) && $label_for_specials_label_style['text_color']){ ?>
								color: <?php echo $label_for_specials_label_style['text_color'] ?>;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['background_color']) && $label_for_specials_label_style['background_color']){ ?>
								background-color: <?php echo $label_for_specials_label_style['background_color'] ?>;
							<?php } ?>
							<?php if(isset($label_for_specials_label_style['height']) && $label_for_specials_label_style['height']){ ?>
								height: <?php echo $label_for_specials_label_style['height'] ?>px;
							<?php } ?>
						}
					</style>
				<?php } ?>
    ...
    <div class="row">
          ...
          <div id="menu" class="navbar  topmenu"> 
            ...
            <nav id='my--menu' class="collapse navbar-collapse navbar-ex11-collapse">
              <ul class="nav toppmenu navbar-nav">
                ...
                <li class="dropdown"><a href="index.php?route=information/information&information_id=16">Акции</a></li>
                <li class="dropdown"><a href="index.php?route=product/category&path=137004">Новинки</a></li>
                <li class="dropdown"><a href="index.php?route=product/manufacturer">Бренды</a></li>
                <li class="dropdown"><a href="index.php?route=information/information&information_id=19">Статьи</a></li>
                <li class="dropdown"><a href="index.php?route=information/information&information_id=14">Наши магазины</a></li>
                <li class="dropdown"><a href="index.php?route=information/information&information_id=20">Контакты</a></li>
              </ul>
            </nav>
          </div>
       </div>
       ...
       <div class="col-xs-3 col-sm-2 col-md-1 col-lg-2 cart1"><?php echo $cart; ?></div>
        ...
        <div class="nomer hidden-md visible-lg-block col-lg-2">
          <ul>
            ...
            <span style="float: right; font-size: 11px;">(ПН-ПТ с 9 до 18)</span>
          </ul>        
        </div>
      ...
      <div class="row my-row">
          ...
          <div class="nomer col-sm-8 col-md-6 col-lg-2">
            ...
            <span class="span1" style="float: right;font-size: 11px;">ПН-ПТ <br> с 9 до 18</span>        
          </div>
