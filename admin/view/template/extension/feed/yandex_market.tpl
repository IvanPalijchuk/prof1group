    ...
    <div class="panel panel-default">
      ...
      <div class="col-sm-10">
          <div class="well well-sm" style="height: 150px; overflow: auto;">
                ...
                <div class="checkbox">
                  <label>
                    <?php if (in_array($man['manufacturer_id'], $yandex_market_manufacturer)) { ?>
            <input type="checkbox" name="yandex_market_manufacturer[]" value="<?php echo $man['manufacturer_id']; ?>" checked="checked" />
            <?php echo $man['name']; ?>
            <?php } else { ?>
            <input type="checkbox" name="yandex_market_manufacturer[]" value="<?php echo $man['manufacturer_id']; ?>" />
            <?php echo $man['name']; ?>
            <?php } ?>
                  </label>
                </div>
