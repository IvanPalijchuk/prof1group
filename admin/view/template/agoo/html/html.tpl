	 ...
	 $('.blog_save_new').html('<?php echo $button_save; ?> ('+$('.hremove[value!=\'remove\']').length+')' );
 	 ...
 	 return false; " class="mbutton button_purple"><?php echo $language->get('sc_button_delete'); ?></a>
						...
						<a onclick="
							...
							$.ajax({
							url: 'index.php?route=module/blog/ajax_list&<?php echo $token_name; ?>=<?php echo $token; ?>',
							type: 'post',
...
<table>
		<tr>
			<td>
				<?php echo $entry_widget_render; ?>
			</td>
			<td>
				<div class="input-group">

					<select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][widget_render]" id="ascp_widgets_<?php echo $list_num; ?>_widget_render">
	                 <?php foreach ($widget_renders as $widget_render => $widget_render_text) { ?>
	                   <option value="<?php echo $widget_render; ?>" <?php
	                   if (isset($list['widget_render']) && $list['widget_render'] == $widget_render) { ?>selected="selected"<?php
	                   } ?>><?php echo $widget_render_text; ?></option>
	                  <?php } ?>
	                 </select>
				</div>
			</td>
		...
		<tr>
				...
				<td class="left">
                 ...
                 <?php echo $language->get('entry_anchor_templates'); ?>
	               ...
	               <div>
					<div class="input-group">
					<select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][anchor_templates]" id="ascp_widgets_<?php echo $list_num; ?>_anchor_templates">
			...
			<td>
				...
				<textarea class="form-control" id="ascp_widgets_<?php echo $list_num; ?>_box_end" name="ascp_widgets[<?php echo $list_num; ?>][box_end]" rows="3" cols="50" ><?php if (isset($list['box_end'])) { echo $list['box_end']; } else { echo ''; } ?></textarea>
                 ...
                 <?php echo $language->get('entry_box_end_templates'); ?>
	               ...
	               <div>
					<div class="input-group">
					<select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][box_end_templates]" id="ascp_widgets_<?php echo $list_num; ?>_box_end_templates">
...
<table>
            ...
            <tr>
              <td><?php echo $language->get('entry_manufacturers'); ?></td>
              <td><div class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($manufacturers as $manufacturer) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div class="<?php echo $class; ?>">
                    <?php if (isset($list['manufacturers']) && in_array($manufacturer['manufacturer_id'], $list['manufacturers'])) { ?>
                    <input type="checkbox" name="ascp_widgets[<?php echo $list_num; ?>][manufacturers][]" value="<?php echo $manufacturer['manufacturer_id']; ?>" checked="checked" />
                    <?php echo $manufacturer['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="ascp_widgets[<?php echo $list_num; ?>][manufacturers][]" value="<?php echo $manufacturer['manufacturer_id']; ?>" />
                    <?php echo $manufacturer['name']; ?>
                    <?php } ?>
                  </div>
                  <?php } ?>
            ...
            <tr>
              <td><?php echo $language->get('entry_products'); ?></td>
              <td>
              <div class="input-group">
              <input class="form-control" type="text" name="ascp_widgets[<?php echo $list_num; ?>][product]" value="" />
              </div>
              </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>
              <div class="scrollbox" id="products_<?php echo $list_num; ?>">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($products as $nm => $product) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="products_<?php echo $list_num; ?>_<?php echo $products['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product['name']; ?><img src="view/image/delete.png" />
                    <input type="hidden" name="ascp_widgets[<?php echo $list_num; ?>][products][]" value="<?php echo $product['product_id']; ?>" />
                  </div>
                  <?php } ?>
                </div>
                </td>
...
$('input[name=\'ascp_widgets[<?php echo $list_num; ?>][product]\']').autocomplete({
	...
	'select': function(event, ui) {
		...
		$('#products_<?php echo $list_num; ?>_' + ivalue).remove();

		$('#products_<?php echo $list_num; ?>').append('<div id="products_<?php echo $list_num; ?>_' + ivalue + '">' + ilabel + '<img src=\"view\/image/delete.png" ><div class="input-group"><input class="form-control" type="hidden" name="ascp_widgets[<?php echo $list_num; ?>][products][]" value="' + ivalue + '" ></div></div>');

		$('#products_<?php echo $list_num; ?> div:odd').prop('class', 'odd');
		$('#products_<?php echo $list_num; ?> div:even').prop('class', 'even');
...
if ($.isFunction($.fn.on)) {
$(document).on('click', '#products_<?php echo $list_num; ?> div img', function() {
	$(this).parent().remove();
...
$('#products_<?php echo $list_num; ?> div img').live('click',  function() {
	$(this).parent().remove();
