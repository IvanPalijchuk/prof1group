<div class="row">
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group"> <div class="form-group required" style="display:none;">
      ...
      <div class="form-group" style="display:none;">
        <label class="control-label" for="input-payment-address-2" style="display:none;"><?php echo $entry_address_2; ?></label>
