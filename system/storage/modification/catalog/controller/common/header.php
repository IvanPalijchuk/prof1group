...
class ControllerCommonHeader extends Controller {
	public function index() {
				...
				/* Label For Specials */
				$data['label_for_specials_label_style'] = $this->config->get('label_for_specials_label_style');
    ...
    // OCFilter end
		...
		if (is_file(DIR_IMAGE . $this->config->get('config_logo'))) {
			...
			if ($data['lang'] == 'ua') {
				$data['logo'] = $server . 'image/'.('ua_logo.png');
			} elseif ($data['lang'] == 'en') {
				$data['logo'] = $server . 'image/'.('en_logo.png');
			}
			
		} else {
			$data['logo'] = $data['logo'] = $server . 'image/'.('en_logo.png');
		}
		...
		$data['text_productnews'] = $this->language->get('text_productnews');
		...
		$data['text_dangers'] = $this->language->get('text_dangers');
		//$data['text_dangers'] = '';
