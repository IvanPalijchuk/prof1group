...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if(isset($this->request->post['email']) || isset($this->request->post['telephone'])){
			...
			$telephone = preg_replace('/(7|8)([0-9]{10})$/','7$2',preg_replace('/[^0-9]{11}/','',$this->request->post['telephone']));
	...
	private function validate() {
		...
		if ($this->model_account_customer->getTotalCustomersByPhone($telephone)) {
