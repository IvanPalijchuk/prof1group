      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr<?php if ($product['quantity'] == 0) { echo " class=\"ara-absent2\""; }?>>
              ...
              <td class="text-right"><?php if ($product['price']) { ?>
                ...
                <?php } ?></td>
              <td class="text-right"><button type="button" <?php if ($product['quantity'] == 0) { echo "disabled"; }?> onclick="cart.add('<?php echo $product['product_id']; ?>');" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i></button>
