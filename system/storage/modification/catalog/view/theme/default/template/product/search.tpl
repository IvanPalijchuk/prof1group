      ...
      <div class="row">
        ...
        <div class="product-layout product-list col-xs-12">
          ...
          <div class="product-thumb <?php if ($product['quantity'] == 0) { echo " ara-absent"; }?>">
                ...
                <?php } ?>
                <?php } ?>
                <?php if($product['sales'] == '1'){ ?><div class="rb-br"><img src="https://prof1group.ua/image/catalog/label/ribbon-sale.png"></div><?php } ?><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" class="img-responsive" /></a></div>
            <div>
              <div class="caption">
