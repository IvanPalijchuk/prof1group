...
<!--BOF Customer Group Price-->
			<div class="form-group">
                <label class="col-sm-2 control-label">
					<span data-toggle="tooltip" title="<?php echo $text_customer_group_price_help; ?>"><?php echo $entry_customer_group_price; ?></span>
				</label>
                <div class="col-sm-10">
						...
						<table class="table table-bordered table-hover">
						  <thead>
							<tr>
							  ...
							  <td class="text-left"><?php echo $entry_customer_group_discount; ?></td>
							  <td class="text-left"><?php echo $entry_customer_group_special; ?></td>
							</tr>
						  </thead>
						  <tbody>							
							<?php $cgp_row = 0; ?>
							<?php foreach($customer_group_discounts as $customer_group_discount){ ?>
							<tr>
							  <td class="text-left"><?php echo $customer_group_discount["name"]; ?></td>
							  <td class="text-center">
								<input type="text" name="customer_group_discount[<?php echo $cgp_row; ?>][price]" value="<?php echo $customer_group_discount["price"]; ?>" class="form-control" />
								<input type="hidden" name="customer_group_discount[<?php echo $cgp_row; ?>][customer_group_id]" value="<?php echo $customer_group_discount["customer_group_id"]; ?>" />
								<input type="hidden" name="customer_group_discount[<?php echo $cgp_row; ?>][name]" value="<?php echo $customer_group_discount["name"]; ?>" />
							  </td>
							  <td class="text-center">						
								<input type="text" name="customer_group_special[<?php echo $cgp_row; ?>][price]" value="<?php echo $customer_group_specials[$cgp_row]["price"]; ?>" class="form-control" />
								<input type="hidden" name="customer_group_special[<?php echo $cgp_row; ?>][customer_group_id]" value="<?php echo $customer_group_specials[$cgp_row]["customer_group_id"]; ?>" />
								<input type="hidden" name="customer_group_special[<?php echo $cgp_row; ?>][name]" value="<?php echo $customer_group_specials[$cgp_row]["name"]; ?>" />
							  </td>
							</tr>
							<?php $cgp_row++; ?>
							<?php } ?>
			...
			<!--EOF Customer Group Price-->
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-sales"><span data-toggle="tooltip" title="<?php echo $help_sales; ?>"><?php echo $entry_sales; ?></span></label>
                <div class="col-sm-10">                  
                    <?php if ($sales == 1) { ?>
