	...
	public function index() {
      ...
      // OCFilter start
		  ...
		  // OCFilter end
            ...
            if ($this->user->hasPermission('access', 'catalog/promotion_label_pro')) {
                $stickers[] = array(
                    'name'     => 'Менеджер стикеров',
                    'href'     => $this->url->link('catalog/promotion_label_pro', 'token=' . $this->session->data['token'], true),
                    'children' => array()   
                );
            }
            
            if ($this->user->hasPermission('access', 'catalog/promotion_label_to_product')) {
                $stickers[] = array(
                    'name'     => 'Товары со стикерами',
                    'href'     => $this->url->link('catalog/promotion_label_to_product', 'token=' . $this->session->data['token'], true),
                    'children' => array()       
                );
            }
