...
$data['button_apply'] = $this->language->get('button_apply');
	...
	public function install() {
		...
		$this->model_extension_event->addEvent('ajax_live_search', 'catalog/view/*/template/common/header/after', 'extension/module/live_search/injectLiveSearch');
	...
	public function uninstall() {
		$this->load->model('extension/event');
		$this->model_extension_event->deleteEvent('ajax_live_search');
	}
}
?>